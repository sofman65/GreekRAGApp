...
export const MobileSidebar = ({ className, children, ...props }: React.ComponentProps<"div">) => {
  ...
  return (
    <>
      <div
        className={cn(
          "h-14 px-4 flex flex-row md:hidden items-center justify-between bg-neutral-100 dark:bg-neutral-800 w-full border-b border-border",
        )}
        {...props}
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-base font-semibold text-neutral-800 dark:text-neutral-200">Ερμής</span>
        </div>
        <AnimatePresence>
          {open && (
            <>
              ...
              <motion.div
                ...
                className={cn(
                  "fixed h-full w-[280px] left-0 top-0 bg-white dark:bg-neutral-900 p-6 z-[100] flex flex-col justify-between border-r border-border shadow-xl",
                  className,
                )}
              >
                <div
